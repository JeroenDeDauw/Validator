...
$messages['be-tarask'] = array(
	...
	'validator_error_parameters' => 'У сынтаксісе {{PLURAL:$1|1=выяўленая наступная памылка|выяўленыя наступныя памылкі}}:', # Fuzzy
	'validator_warning_parameters' => 'У Вашы сынтаксісе {{PLURAL:$1|1=маецца памылка|маюцца памылкі}}.', # Fuzzy
	'validator-warning-adittional-errors' => '... і {{PLURAL:$1|1=яшчэ адна праблема|яшчэ некалькі праблемаў}}.', # Fuzzy
	'validator-error-omitted' => '{{PLURAL:$2|1=Значэньне «$1» было прапушчанае|Значэньні «$1» былі прапушчаныя}}.', # Fuzzy
...
Зьмясьціце listerrors у самы канец старонкі, каб атрымаць сьпіс усіх памылак.',
	...
	'validator-describe-aliases' => "'''{{PLURAL:$2|1=Псэўданім|Псэўданімы}}''': $1", # Fuzzy
...
{{PLURAL:$3|1=Ён мусіць мець наступнае значэньне|Яны мусяць мець наступныя значэньні}}: $2.', # Fuzzy
	'validator-list-error-accepts-only-omitted' => 'Адзін ці некалькі значэньняў парамэтру $1 зьяўляюцца няслушнымі.
{{PLURAL:$3|1=Ён мусіць мець наступнае значэньне|Яны мусяць мець наступныя значэньні}}: $2. (і $4  {{PLURAL:$4|прапушчанае значэньне|прапушчаныя значэньні|прапушчаных значэньняў}}).', # Fuzzy
	'validator_error_accepts_only' => 'Значэньне «$4» зьяўляецца няслушным для парамэтру $1. Ён можа прымаць толькі {{PLURAL:$3|1=гэтае значэньне|гэтыя значэньні}}: $2.', # Fuzzy
	'validator-error-accepts-only-omitted' => 'Значэньне «$2» зьяўляецца няслушным для парамэтру $1.
{{PLURAL:$5|1=Ён мусіць мець наступнае значэньне|Яны мусяць мець наступныя значэньні}}: $3. (і $4  {{PLURAL:$4|прапушчанае значэньне|прапушчаныя значэньні|прапушчаных значэньняў}}).', # Fuzzy
	'validator_list_omitted' => '{{PLURAL:$2|1=Значэньне|Значэньні}} $1 {{PLURAL:$2|1=было прапушчанае|былі прапушчаныя}}.', # Fuzzy
 ...
 */
$messages['ce'] = array(
	'validator-warning-adittional-errors' => '… и {{PLURAL:$1|1=кхин цхьа бала|кхин маситта баланаш}}.', # Fuzzy
